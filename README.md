...
1. **Windows 10**
```
wget -O- --no-check-certificate https://image.yha.my.id/4:/windows10.gz | gunzip | dd of=/dev/vda
```
2. **Windows Server 2012 R2**
```
wget -O- --no-check-certificate https://image.yha.my.id/4:/indows2012.gz | gunzip | dd of=/dev/vda
```
3. **Windows Server 2016**
```
wget -O- --no-check-certificate https://image.yha.my.id/4:/windows2016.gz | gunzip | dd of=/dev/vda
```
4. **Windows Server 2019**
```
wget -O- --no-check-certificate https://image.yha.my.id/4:/windows2019.gz | gunzip | dd of=/dev/vda
```
5. **Windows Server 2022**
```
wget -O- --no-check-certificate https://image.yha.my.id/4:/windows2022.gz | gunzip | dd of=/dev/vda
```
