...
case "$selectos" in
	1|"") selectos="https://image.yha.my.id/5:/windows10.gz";;
	2) selectos="https://image.yha.my.id/5:/windows2012.gz";;
	3) selectos="https://image.yha.my.id/5:/windows2016.gz";;
	4) selectos="https://image.yha.my.id/5:/windows2019.gz";;
	5) selectos="https://image.yha.my.id/5:/windows2022.gz";;
...
wget --no-check-certificate -O- $selectos | gunzip | dd of=/dev/sda bs=3M status=progress
